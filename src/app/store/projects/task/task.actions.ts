...
export const addTaskActionOnError = createAction('[Task] Add Task Error', props<{ message: string }>());
...
export const deleteTaskActionOnError = createAction('[Task] Delete Task Error', props<{ message: string }>());
...
export const changeTaskActionOnError = createAction('[Task] Change Task Error', props<{ message: string }>());