...
export const registerOnError = createAction('[User] Error Register Request', props<{ email: string, error: HttpErrorResponse }>());
...
export const loginOnError = createAction('[User] Error Login Request', props<{ email: string, error: HttpErrorResponse }>());
